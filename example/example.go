...
type Chassis struct {
	...
	NetInterfaces []NetInterface `yaml:"interfaces" json:"interfaces" ovskv:"interfaces"`
}
...
type Tenant struct {
	UUID               string              `ovskv:"_uuid"`
	Name               string              `yaml:"name" json:"name" ovskv:"name"`
	OverlayIPv4Subnets []OverlayIPv4Subnet `yaml:"overlayIPv4Subnets" json:"overlayIPv4Subnets" ovskv:"overlayIPv4Subnets"`
	Chassis            []Chassis           `yaml:"chassis" json:"chassis" ovskv:"chassis"`
	Services           []Service           `yaml:"services" json:"services" ovskv:"services"`
	ACLs               []ACL               `yaml:"acls" json:"acls" ovskv:"acls"`
}

type NetworkLayout struct {
	AddressSets []AddressSet `yaml:"addressSets" json:"addressSets" ovskv:"addressSets"`
	Tenants     []Tenant     `yaml:"tenants" json:"tenants" ovskv:"tenants"`
}
...
func main() {
	a := NetworkLayout{
		...
		Tenants: []Tenant{
			{
				OverlayIPv4Subnets: []OverlayIPv4Subnet{
				},
				Chassis: []Chassis{
					{
